...
export default function Home() {
  ...
  return (
    <motion.div className="px-4 md:px-6 pt-8 relative">
      <Head>
      ...
      <footer
        className={`left-0 w-full mix-blend-difference grid text-[rgba(255,255,255,.9)] grid-cols-12 gap-6 pt-12 pb-4`}
      >
