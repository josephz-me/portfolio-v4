    ...
    <motion.div className="px-6 pt-8 pb-20 relative">
      ...
      >
        <motion.img
          ...
          className={`${
            scrollY > 200 ? "md:opacity-0" : "bg-[rgba(255,255,255,.05)]"
          } w-[48px] h-[48px] col-start-1 col-end-3 p-3 md:fixed z-10 text-[rgba(255,255,255,.9)] rounded-md p-2 transition duration-[200ms] ease-[cubic-bezier(0.22, 1, 0.36, 1)]`}
        />
        <motion.p
          className={`${
            scrollY > 40
              ? "md:opacity-0 text-[rgba(255,255,255,.9)]"
