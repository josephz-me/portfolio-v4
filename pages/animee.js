...
import MobileMockupWithFrame from '../components/projects/MobileMockupWithFrame';
...
export default function Animee() {
  ...
  return (
    <main className="min-h-[70vh]">
      <GridContainer>
        ...
        <ProjectTitle role="Mobile app">Anime.com</ProjectTitle>
        <ProjectBody col={2}>
